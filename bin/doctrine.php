 ...
 *   1. Carga Composer
 *   2. Carga .env
 *   3. Obtiene el EntityManager (config/doctrine.php)
 *   4. Lee la config de migrations (config/migrations.php)
...
// Se cargan antes que nada porque config/doctrine.php las necesita
...
$cli = new Application('LDL UNSADA TPI - Doctrine Migrations', '1.0.0');
