...
class CredentialController {
    ...
    private function create(): void {
        ...
        $fechaVencimiento = \DateTimeImmutable::createFromFormat('Y-m-d', $data['fecha_vencimiento']);
        if (!$fechaVencimiento) {
        ...
        $credencial->setFechaEmision(new \DateTimeImmutable('today'));
    ...
    private function update(int $id): void {
        ...
        if (!empty($data['fecha_vencimiento'])) {
            $nuevaFecha = \DateTimeImmutable::createFromFormat('Y-m-d', $data['fecha_vencimiento']);
            if (!$nuevaFecha) {
                $this->responder(400, 'error', 'Formato de fecha inválido. Use YYYY-MM-DD.');
                return;
            }
    ...
    private function renew(int $id): void {
        ...
        $nuevaCred->setFechaEmision(new \DateTimeImmutable('today'));
